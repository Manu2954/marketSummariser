...
const toolDefinitionTapeRead = {
  ...
  description:
    'Fetches OHLCV candles and returns a FeatureReport with strict tape-reading instructions for the calling model to summarize.',
  inputSchema: sharedInputSchema,
};
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  ...
  try {
    ...
    const tapeReadPayload = {
      ...
      note:
        'Use the instructions to produce the structured tape-reading answer. Do not add indicators, predictions, or signals.',
    };
